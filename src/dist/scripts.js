...
var DOM = {
    ...
    addTransaction: function (transaction, index) {
        ...
        (_a = DOM.transactionContainer) === null || _a === void 0 ? void 0 : _a.appendChild(tr);
    },
    ...
    updateBalance: function () {
        var income = document.getElementById('incomeDisplay');
        if (income != null) {
            income.innerHTML = Utils.formatCurrency(Transaction.incomes());
        }
        var expense = document.getElementById('expenseDisplay');
        if (expense != null) {
    ...
    clearTransaction: function () {
        var transaction = DOM.transactionContainer;
        if (transaction != null) {
